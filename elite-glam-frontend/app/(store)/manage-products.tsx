import { StyleSheet, Text, View, ScrollView, TouchableOpacity, Image, TextInput, FlatList, Alert, ActivityIndicator, Platform } from 'react-native';
...
export default function ManageProductsScreen() {
  ...
  const checkUserAndFetchProducts = useCallback(async (pageNumber: number = 1, shouldRefresh: boolean = false) => {
    try {
      ...
      const fetchedProducts = await productsService.getAllProducts(user.uid, pageNumber, ITEMS_PER_PAGE);
