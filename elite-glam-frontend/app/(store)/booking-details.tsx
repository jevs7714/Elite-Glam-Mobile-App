      ...
      <View style={styles.chatDrawer}>
        <View style={styles.chatHeader}>
          <Text style={styles.chatHeaderTitle}>
            Chat with {booking.ownerUsername}
          </Text>
      ...
      >
            ...
            <View style={styles.rejectionMessageContainer}>
              ...
              <Text style={styles.rejectionMessageText}>
                {booking.rejectionMessage
                  ? `Rejection Reason: ${booking.rejectionMessage}`
                  : "This booking has been rejected by the seller."}
              </Text>
            </View>
          )}
        </View>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoText}>
              {booking.time}
              {booking.eventTimePeriod ? ` ${booking.eventTimePeriod}` : ""}
            </Text>
          </View>
          {booking.eventType && (
            <View style={styles.infoRow}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoText}>
              {booking.productId || "Not available"}
            </Text>
          </View>
          <View style={styles.infoRow}>
            <MaterialIcons name="person" size={20} color="#666" />
