...
export default function OrderDetailsScreen() {
  ...
  const handleRejectBooking = async (rejectionMessage: string) => {
    ...
    try {
      setActionLoading(true);
      await bookingService.updateBookingStatus(booking.id, 'rejected', rejectionMessage);
        ...
        { 
          ...
          onPress: async () => {
            try {
              ...
              Alert.alert(
                'Success',
                'The order has been completed and archived successfully.',
                [
                  { 
                    text: 'OK', 
                    onPress: () => router.back() 
    ...
    return (
      <View style={styles.chatDrawer}>
        <View style={styles.chatHeader}>
          <Text style={styles.chatHeaderTitle}>Chat with {booking?.customerName}</Text>
    ...
    return (
      <View style={styles.modalOverlay}>
        <View style={styles.modalContent}>
          ...
          <Text style={styles.modalLabel}>Please provide a reason for rejecting this order:</Text>
          <TextInput
    ...
    if (booking.status === 'rejected') {
      return (
        <View style={styles.actionButtonsWrapper}>
          ...
          <MaterialIcons name="chevron-right" size={24} color="#666" style={styles.scrollIcon} />
        </View>
      );
    }
      ...
      <ScrollView style={styles.scrollView}>
        ...
        <View style={styles.card}>
          ...
          <View style={styles.infoRow}>
            ...
            <Text style={styles.infoText}>{booking.time} {booking.eventTimePeriod}</Text>
          </View>
          <View style={styles.infoRow}>
            ...
            <View style={styles.notesContainer}>
              ...
              <View style={styles.notesContent}>
                <View style={styles.noteItem}>
                  ...
                  <Text style={styles.notesText}>{booking.eventLocation || 'Not specified'}</Text>
                </View>
                <View style={styles.noteItem}>
                ...
                <View style={styles.noteItem}>
                  ...
                  <Text style={styles.notesText}>
                    ...
                    {`Fitting Time: ${booking.fittingTime || 'Not specified'} ${booking.fittingTimePeriod || ''}\n`}
                    {`Event Time: ${booking.time || 'Not specified'} ${booking.eventTimePeriod || ''}`}
                  </Text>
                </View>
              </View>
            </View>
