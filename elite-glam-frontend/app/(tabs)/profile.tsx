  ...
  const loadUserData = async (showLoading = true) => {
    try {
      ...
      console.log('API Response:', JSON.stringify(response.data, null, 2));
        ...
        const userData: UserData = {
          ...
          profile: {
            ...
            photoURL: response.data.profile?.photoURL || storedUserData?.profile?.photoURL,
      ...
      if (storedUserData) {
        ...
        console.log('Loaded from storage:', JSON.stringify(parsedData, null, 2));
          ...
          <View style={styles.avatarContainer}>
            {isLoading ? (
              ...
              <Image 
                ...
                onLoad={() => {
                  if (userData?.profile?.photoURL) {
                    console.log('Image loaded successfully:', userData.profile.photoURL);
                  }
                }}
              />
            ) : (
